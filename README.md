# Репликация и масштабирование. Часть 1 - Мелетьев Роман Андреевич
...
В режиме репликации master-slave  пользователь пишет данные в базу master, а она, в свою очередь пишет данные в базу slave. Читать данные пользователь может с обеих баз. База master также может читать из базы slave по необходимости.

В режиме репликации master-master пользователь пишет и читает из любой базы. Базы также могут по необходимости писать и читать друг друга.
